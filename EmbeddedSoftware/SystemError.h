...
{
	//JSON配置文件读写相关的错误项
	SYSTEMINFO_NOT_EXIST,SYSTEMINFO_CHECKOUT_FAIL,SYSTEMINFO_READ_FAIL,SYSTEMINFO_WRITE_FAIL,
	CHANNELSETTINGS_NOT_EXIST,CHANNELSETTINGS_CHECKOUT_FAIL,CHANNELSETTINGS_READ_FAIL,CHANNELSETTINGS_WRITE_FAIL,
